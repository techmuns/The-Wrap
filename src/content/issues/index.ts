...
import i0 from "./2026-09-20";
import i1 from "./2026-09-13";
import i2 from "./2026-09-06";
import i3 from "./2026-08-31";
import i4 from "./2025-11-30";
import i5 from "./2024-11-17";
...
export const issues: Issue[] = [i0, i1, i2, i3, i4, i5].sort((a, b) => b.isoDate.localeCompare(a.isoDate));
